...
namespace FormCore {
  public class SectionsServices<TForm, TSection>
    ...
    public static int Create(Context db, int id, FSection input, Func<TForm, bool> viewPermitting = null, Func<TForm, bool> editPermitting = null,
    ...
    public static void Update(Context db, int id, int sectionId, FSection input, Func<TForm, bool> viewPermitting = null, Func<TForm, bool> editPermitting = null, Action<TSection> after = null) {
      var form = Form.Load(db, id) as TForm;
      if (null != editPermitting && !editPermitting.Invoke(form)) throw new AccessDenied();
